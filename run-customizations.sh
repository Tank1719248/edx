#!/bin/bash
#
# Copyright (c) microsoft1 Corporation. All Rights Reserved.
...
OXA_TOOLS_PUBLIC_GITHUB_ACCOUNTNAME="microsoft1"
...
EDX_CONFIGURATION_PUBLIC_GITHUB_ACCOUNTNAME="microsoft1"
...
help()
{
    ...
    echo "        --import-kitchensink-course Indicator of whether not not to import the microsoft1 Kitchen Sink sample course."
